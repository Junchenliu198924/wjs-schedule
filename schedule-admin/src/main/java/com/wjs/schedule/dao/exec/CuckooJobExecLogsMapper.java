...
public interface CuckooJobExecLogsMapper {
    /**
     * cockoo_job_exec_logs数据表的操作方法: countByExample  
     * 
     */
    int countByExample(CuckooJobExecLogsCriteria example);

    /**
     * cockoo_job_exec_logs数据表的操作方法: deleteByExample  
     * 
     */
    int deleteByExample(CuckooJobExecLogsCriteria example);

    /**
     * cockoo_job_exec_logs数据表的操作方法: deleteByPrimaryKey  
     * 
     */
    int deleteByPrimaryKey(Long jobId);

    /**
     * cockoo_job_exec_logs数据表的操作方法: insert  
     * 
     */
    int insert(CuckooJobExecLogs record);

    /**
     * cockoo_job_exec_logs数据表的操作方法: insertSelective  
     * 
     */
    int insertSelective(CuckooJobExecLogs record);

    /**
     * cockoo_job_exec_logs数据表的操作方法: selectByExample  
     * 
     */
    List<CuckooJobExecLogs> selectByExample(CuckooJobExecLogsCriteria example);

    /**
     * cockoo_job_exec_logs数据表的操作方法: selectByPrimaryKey  
     * 
     */
    CuckooJobExecLogs selectByPrimaryKey(Long jobId);

    /**
     * cockoo_job_exec_logs数据表的操作方法: lockByPrimaryKey  
     * 
     */
    CuckooJobExecLogs lockByPrimaryKey(Long jobId);

    /**
     * cockoo_job_exec_logs数据表的操作方法: lockByExample  
     * 
     */
    CuckooJobExecLogs lockByExample(CuckooJobExecLogsCriteria example);

    /**
     * cockoo_job_exec_logs数据表的操作方法: pageByExample  
     * 
     */
    PageDataList<CuckooJobExecLogs> pageByExample(CuckooJobExecLogsCriteria example);

    /**
     * cockoo_job_exec_logs数据表的操作方法: lastInsertId  
