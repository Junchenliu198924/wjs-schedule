...
public class CuckooJobDetails implements Serializable {
    ...
    /**
     * 并发/集群任务参数 -- cockoo_job_details.cuckoo_parallel_job_args
     * 
     */
    ...
    /**
     * 数据字段 cockoo_job_details.cuckoo_parallel_job_args的get方法 
     * 
     */
    ...
    /**
     * 数据字段 cockoo_job_details.cuckoo_parallel_job_args的set方法
     * 
     */
