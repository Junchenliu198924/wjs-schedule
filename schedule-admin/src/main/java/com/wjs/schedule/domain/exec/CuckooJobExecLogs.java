...
public class CuckooJobExecLogs implements Serializable {
    ...
    /**
     * 执行器IP -- cockoo_job_exec_logs.exec_client_ip
     * 
     */
    private String execClientIp;

    /**
     * 执行器端口 -- cockoo_job_exec_logs.exec_client_port
     * 
     */
    private Integer execClientPort;
    ...
    /**
     * 数据字段 cockoo_job_exec_logs.exec_client_ip的get方法 
     * 
     */
    public String getExecClientIp() {
        return execClientIp;
    }

    /**
     * 数据字段 cockoo_job_exec_logs.exec_client_ip的set方法
     * 
     */
    public void setExecClientIp(String execClientIp) {
        this.execClientIp = execClientIp == null ? null : execClientIp.trim();
    }

    /**
     * 数据字段 cockoo_job_exec_logs.exec_client_port的get方法 
     * 
     */
    public Integer getExecClientPort() {
        return execClientPort;
    }

    /**
     * 数据字段 cockoo_job_exec_logs.exec_client_port的set方法
     * 
     */
    public void setExecClientPort(Integer execClientPort) {
        this.execClientPort = execClientPort;
    }
